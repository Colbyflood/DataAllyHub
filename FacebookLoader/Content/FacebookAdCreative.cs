...
public class FacebookAssetFeedSpecData
{
    public string ImageHash { get; set; }
    public FacebookAssetFeedSpecData(string imageHash)
    {
        ImageHash = imageHash;
    }
}
...
public class FacebookCreative
{
    ...
    public FacebookAssetFeedSpecData AssetFeedSpecData { get; }
    ...
    public FacebookCreative(string id, string status, string actorId,
        ...
        FacebookVideoData videoData, FacebookLinkData linkData, FacebookPhotoData photoData, FacebookAssetFeedSpecData assetFeedSpecData)
    {
        Id = id;
        Status = status;
        ActorId = actorId;
        ...
        LinkData = linkData;
        PhotoData = photoData;
        AssetFeedSpecData = assetFeedSpecData;
    }
}
