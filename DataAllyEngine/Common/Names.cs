...
public class Names
{
    ...
    public const string FEED_TYPE_AD_IMAGE = "AdImage";

    public const string SCOPE_TYPE_DAILY = "Daily";
    public const string SCOPE_TYPE_BACKFILL = "Backfill";

    public const string FB_PROBLEM_NO_TOKEN = "NoTokenFound";
    public const string FB_PROBLEM_STALLED = "Stalled";
    public const string FB_PROBLEM_NO_CONNECTION = "NoConnection";
    public const string FB_PROBLEM_BAD_TOKEN = "BadToken";
    public const string FB_PROBLEM_NOT_PERMITTED = "NotPermitted";
